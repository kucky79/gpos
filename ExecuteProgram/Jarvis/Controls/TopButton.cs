...
namespace Bifrost.Win
{
	...
	public class TopButton : UserControl
	{
			...
			foreach (Control itm in this.Parent.Controls)
			{
				...
				if (this.GetType().Name == itmTypeName)
				{
					if (itm.Name != this.Name)
					{
						...
						{
							if (((TopButton)itm).GroupKey == this.GroupKey)
							{
								((TopButton)itm).Selected = true;
							}
						}
						else
						{
							if (((TopButton)itm).GroupKey == null)
							{
								((TopButton)itm).Selected = false;
							}
						}
					}
				}
        ...
        public class SelectedChangedEventArgs : EventArgs
        {
            ...
            public SelectedChangedEventArgs(TopButton theButton)
            {
