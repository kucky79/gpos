    ...
    partial class M_POS_SALE_RECEIPT
    {
        ...
        private void PrintReceit()
        {
            try
            {
                ...
                sb.Append("고  객  명 : " + A.GetString(gridViewList.GetFocusedRowCellValue("NM_CUST")) + "\n");
                sb.Append(PrinterCommand.InitializePrinter);
                ...
                sb.Append("판매  시간 : " + A.GetString(gridViewList.GetFocusedRowCellValue("TM_SALE")) + "\n");
                sb.Append("==========================================\n");
        ...
        private void PrintWorkSheet()
        {
            try
            {
                ...
                sb.Append(PrinterCommand.ConvertFontSize(1, 2));
                sb.Append("고  객  명 : " + A.GetString(gridViewList.GetFocusedRowCellValue("NM_CUST")) + "\n");
                sb.Append("차      량 : " + A.GetString(gridViewList.GetFocusedRowCellValue("NO_CAR")) + "\n");
                sb.Append(PrinterCommand.InitializePrinter);
