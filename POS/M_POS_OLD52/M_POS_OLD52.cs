...
namespace POS
{
    public partial class M_POS_OLD52 : POSFormBase
    {
        public M_POS_OLD52()
        {
            InitializeComponent();
        ...
        {
            POSPrintHelper.POSReportPrintOld("R_POS_OLD52", new string[] { "CD_STORE", "DT_FROM", "DT_TO" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text });
        }
