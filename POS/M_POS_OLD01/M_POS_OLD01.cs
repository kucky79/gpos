...
namespace POS
{
    public partial class M_POS_OLD01 : POSFormBase
    {
        public M_POS_OLD01()
        {
            InitializeComponent();
        ...
        {
           POSPrintHelper.POSReportPrintOld("R_POS_OLD01", new string[] { "CD_STORE", "DT_FROM", "DT_TO" }, new string[] { POSGlobal.StoreCode, dtpSearch.Text.Substring(0,6), dtpSearch.Text.Substring(0,6) });
        }
