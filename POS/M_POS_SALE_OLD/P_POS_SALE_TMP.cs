...
namespace POS
{
    public partial class P_POS_SALE_TMP : POSPopupBase
    {
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                bool result = DBHelper.ExecuteNonQuery("USP_POS_SO_TMP_D", new object[] { POSGlobal.StoreCode, SlipNo });
                if (result)
                {
        ...
        {
            _dt = Search(new object[] { POSGlobal.StoreCode, dtpSale.Text, CustomerCode });
