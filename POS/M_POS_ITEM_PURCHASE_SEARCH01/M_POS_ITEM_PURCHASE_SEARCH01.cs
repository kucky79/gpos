...
namespace POS
{
    public partial class M_POS_ITEM_PURCHASE_SEARCH01 : POSFormBase
    {
        DataTable _dtUnitSum;

        public M_POS_ITEM_PURCHASE_SEARCH01()
        {
            InitializeComponent();
            InitControl();
            InitEvent();
        ...
        {
            panelControlHeader.Size = new System.Drawing.Size(panelControlHeader.Size.Width, 46 + tokenEditItem.Size.Height);
        }
        ...
        {
            GridHelper.ExcelExport(gridMain, "상품별구매현황");
        }
        ...
        {
            POSPrintHelper.POSReportPrint("R_POS_ITEM_PURCHASE_SEARCH01", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "CD_ITEM" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, string.Empty, CH.GetTokenString(tokenEditItem) });// A.GetDatatableToString(aLookUpEditItem.Properties.DataSource) });
        }
        ...
        private void PrintNormalDetail()
        {
            ...
            {
                POSPrintHelper.POSReportPrint("R_POS_ITEM_PURCHASE_SEARCH02", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "CD_ITEM" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, string.Empty, A.GetString(gridViewMain.GetFocusedRowCellValue("CD_ITEM")) });
            }
            else
            {
