...
namespace POS
{
    partial class M_POS_PURCHASE
    {
        ...
        {
            return A.GetDecimal(DBHelper.ExecuteScalar("USP_GET_POS_ITEM_UNIT_PRICE_LAST", new object[] { POSGlobal.StoreCode, CustomerCode, _itemCode, unitCode, CustomerType }));
        }
