...
namespace POS
{
    public partial class M_POS_PURCHASE : POSFormBase
    {
        #region 변수모음
        //터치 버튼 생성자
        ...
        string CustomerType = "P"; // S 판매 : P 구매 기본값은 S
        string UseInventory = "Y"; //재고사용
        string UseItem = "Y";
        ...
        readonly Color ColorFontText = Color.FromArgb(42, 151, 57);

        readonly Color ColorMain = Color.FromArgb(112, 173, 71);
        readonly Color ColorSub = Color.FromArgb(198, 224, 180);
        readonly Color ColorPress = Color.FromArgb(24, 114, 66);
        ...
        public M_POS_PURCHASE()
        {
            InitializeComponent();
            InitKeyPad();

            CH.SetButtonApperanceSub(btnKeyClear, false);
            CH.SetButtonApperanceSub(btnKeyBackSpace, false);
            CH.SetButtonApperanceSub(btnKeyMinus, false);
            CH.SetButtonApperanceSub(btnKeyPoint, false);

            CH.SetButtonApperanceMain(btnKey1, false);
            CH.SetButtonApperanceMain(btnKey2, false);
            CH.SetButtonApperanceMain(btnKey3, false);
            CH.SetButtonApperanceMain(btnKey4, false);
            CH.SetButtonApperanceMain(btnKey5, false);
            CH.SetButtonApperanceMain(btnKey6, false);
            CH.SetButtonApperanceMain(btnKey7, false);
            CH.SetButtonApperanceMain(btnKey8, false);
            CH.SetButtonApperanceMain(btnKey9, false);
            CH.SetButtonApperanceMain(btnKey0, false);
            CH.SetButtonApperanceMain(btnKey00, false);
        ...
        void UpdateSVGStyle(SvgElement element, Hashtable hashtable)
        {
            hashtable["Stroke"] = "#2A9739";
        }
        ...
        private void InitContentsPanel()
        {
            ...
            btnContentsSearch.Appearance.ForeColor = ColorFontText;
            ...
            btnContentsSearch.ImageOptions.SvgImage = global::POS.Properties.Resources.search_icon;
            ...
            btnFavorite.Appearance.ForeColor = ColorFontText;
            ...
            btnFavorite.ImageOptions.SvgImage = global::POS.Properties.Resources.star_icon;
            ...
            btnInit.Appearance.ForeColor = ColorFontText;
            ...
            btnInit.ImageOptions.SvgImage = global::POS.Properties.Resources.refresh_icon;
            ...
            btnItemType.Appearance.ForeColor = ColorFontText;
            ...
            btnItemType.ImageOptions.SvgImage = global::POS.Properties.Resources.itemtype_icon;
            ...
            btnTop.Appearance.ForeColor = ColorFontText;
            ...
            btnPre.Appearance.ForeColor = ColorFontText;
            ...
            btnNext.Appearance.ForeColor = ColorFontText;
            ...
            btnClose.Appearance.ForeColor = ColorFontText;
        ...
        private void InitKeyPad()
        {
            ...
            this.separatorControlKeypad1.LineColor = ColorMain;
            ...
            this.separatorControlKeypad2.LineColor = ColorMain;
            ...
            this.txtPadQty.Properties.Appearance.ForeColor = ColorFontText;
            ...
            this.txtPadItem.Appearance.ForeColor = ColorFontText;
            ...
            this.btnPadPrice.Appearance.Font = FontKeypad;
            ...
            this.btnPadCancel.Appearance.Font = FontKeypad;
            ...
            this.btnPadDelItem.Appearance.Font = FontKeypad;
            ...
            this.btnPadInit.Appearance.Font = FontKeypad;
            ...
            this.btnPadMinus.Appearance.Font = FontKeypad;
            ...
            this.btnPadEA.Appearance.Font = FontKeypad;
            ...
            this.btnPadConfirm.Appearance.Font = FontKeypad;
            ...
            this.btnPadItemUnit4.Appearance.Font = FontKeypad;
            ...
            this.btnPadItemUnit3.Appearance.Font = FontKeypad;
            ...
            this.btnPadItemUnit2.Appearance.Font = FontKeypad;
            ...
            this.btnPadItemUnit1.Appearance.Font = FontKeypad;
            ...
            this.btnPadPoint.Appearance.Font = FontKeypad;
            ...
            this.btnPadBackSpace.Appearance.Font = FontKeypad;
            ...
            this.btnPadClear.Appearance.Font = FontKeypad;
            ...
            this.btnPad000.Appearance.Font = FontKeypad;
            ...
            this.btnPad00.Appearance.Font = FontKeypad;
            ...
            this.btnPad0.Appearance.Font = FontKeypad;
            ...
            this.btnPad3.Appearance.Font = FontKeypad;
            ...
            this.btnPad2.Appearance.Font = FontKeypad;
            ...
            this.btnPad1.Appearance.Font = FontKeypad;
            ...
            this.btnPad6.Appearance.Font = FontKeypad;
            ...
            this.btnPad5.Appearance.Font = FontKeypad;
            ...
            this.btnPad4.Appearance.Font = FontKeypad;
            ...
            this.btnPad9.Appearance.Font = FontKeypad;
            ...
            this.btnPad8.Appearance.Font = FontKeypad;
            ...
            this.btnPad7.Appearance.Font = FontKeypad;
            ...
            CH.SetButtonApperanceSub(btnPadMinus, false);
            CH.SetButtonApperanceSub(btnPadEA, false);
            CH.SetButtonApperanceSub(btnPadMinus, false);
            CH.SetButtonApperanceSub(btnPadPoint, false);
            CH.SetButtonApperanceSub(btnPadClear, false);
            CH.SetButtonApperanceSub(btnPadBackSpace, false);

            CH.SetButtonApperanceMain(btnPad1, false);
            CH.SetButtonApperanceMain(btnPad2, false);
            CH.SetButtonApperanceMain(btnPad3, false);
            CH.SetButtonApperanceMain(btnPad4, false);
            CH.SetButtonApperanceMain(btnPad5, false);
            CH.SetButtonApperanceMain(btnPad6, false);
            CH.SetButtonApperanceMain(btnPad7, false);
            CH.SetButtonApperanceMain(btnPad8, false);
            CH.SetButtonApperanceMain(btnPad9, false);
            CH.SetButtonApperanceMain(btnPad0, false);
            CH.SetButtonApperanceMain(btnPad00, false);
            CH.SetButtonApperanceMain(btnPad000, false);
        ...
        {
            _dtCust = SearchCust(new object[] { POSGlobal.StoreCode, string.Empty, "Y", dtpSale.Text, CustomerType });
            SetContents();
            SetNaviButton();
        }
        ...
        private void BtnCtsItemType_Click(object sender, EventArgs e)
        {
            ...
            if (gridViewItem.RowCount + 1 > index)
                panelGridNav.Visible = true;
            else
                panelGridNav.Visible = false;
        }
            ...
            if (P_POS_INITIAL.ShowDialog() == DialogResult.OK)
            {
                ...
                if (ContentsType == ContentsMode.Customer)
                {
                    if (P_POS_INITIAL.ResultText == string.Empty)
                        ...
                        _dtCust = SearchCust(new object[] { POSGlobal.StoreCode, P_POS_INITIAL.ResultText, "Y", dtpSale.Text, CustomerType });
                }
                else
                {
                    if (P_POS_INITIAL.ResultText == string.Empty) //전체검색
                        _dtItem = SearchItem(new object[] { POSGlobal.StoreCode, P_POS_INITIAL.ResultText, string.Empty, string.Empty, UseItem });
                    else
                        _dtItem = SearchItem(new object[] { POSGlobal.StoreCode, P_POS_INITIAL.ResultText, "ALL", string.Empty, UseItem });
                }
                SetContents();
                SetNaviButton();
                //SetItemTypeScreen(IsItemTypeScreen);
        ...
        private void BtnCtrTmpSave_Click(object sender, EventArgs e)
        {
            try
            {
                        ...
                        if (returnRow != null)
                        {
                            ...
                            switch (TmpOrderType)
                            {
                                case TempOrderType.Order:
                                    ...
                                    #region 행추가
                                    _dsTmp = SearchTempOrderByOrder(new object[] { POSGlobal.StoreCode, A.GetString(returnRow["NO_SLIP"]), "P" });
                                ...
                                case TempOrderType.Customer:
                                    ...
                                    #region 행추가
                                    _dsTmp = SearchTempOrderByCustomer(new object[] { POSGlobal.StoreCode, dtpSale.Text, CustomerCode, "P" });
                            ...
                            decimal NonpaidAmt = GetNonPaidAmt(new object[] { POSGlobal.StoreCode, CustomerCode, string.Empty, dtpSale.Text, "P" });
                ...
                else
                {
                    ...
                    {
                        SlipNo = A.GetPOSSlipNo(POSGlobal.StoreCode, SaleDt, "TPO", 4);
                    }
                    else
                    {
                    ...
                    if (_dtH.Rows.Count == 0)
                    {
                        ...
                        drNew["FG_PO"] = "T"; //일반전표 : A, 반품 전표: R, 임시저장 전표 : T, 수금만 있는 전표 :P

                        _dtH.Rows.Add(drNew);
                    }
                    else
                    {
                        _dtH.Rows[0]["NO_PO"] = SlipNo;
                        _dtH.Rows[0]["DT_PO"] = SaleDt;
                        _dtH.Rows[0]["CD_CUST"] = CustomerCode;
                        _dtH.Rows[0]["FG_PO"] = "T"; //일반전표 : A, 반품 전표: R, 임시저장 전표 : T, 수금만 있는 전표 :P
                    }
                    ...
                    if (SaveTemp(dtHChange, dtLChange, listParam))
                    {
                        ...
                        if (SlipNoTemp != null && SlipNoTemp.Count > 0)
                        {
                            ...
                            {
                                DeleteTemp(new object[] { POSGlobal.StoreCode, SlipNoTemp[i], "P" });
                            }
                            SlipNoTemp.Clear();
                        }
        ...
        private void BtnCtrReturn_Click(object sender, EventArgs e)
        {
            ...
            else if (SlipNoPay == string.Empty)
            {
        ...
        private void BtnCtrReorder_Click(object sender, EventArgs e)
        {
            ...
            if (ShowMessageBoxA("재주문하시겠습니까?", MessageType.Question) == DialogResult.Yes)
            {
                ...
                //외상잔액
                decimal NonpaidAmt = GetNonPaidAmt(new object[] { POSGlobal.StoreCode, CustomerCode, SlipNo, dtpSale.Text, "P" });
            ...
            try
            {
                ...
                switch (SlipFlag)
                {
                    case "A"://정상 판매
                        ...
                        if (P_POS_PRINT_SALE.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            switch (result)
                            {
                                ...
                                case "W": //작업서
                                    ...
                                    break;
                                case "I": //거래명세        
                                    POSPrintHelper.POSReportPrint("POS_SALE_RPT01", new string[] { "CD_STORE", "NO_PO" }, new string[] { POSGlobal.StoreCode, SlipNo });
                                    break;
                                case "N": //미발행
                                    break;
                                default:
                        ...
                        break;
                    case "P"://수금만
                        P_POS_PRINT_PAY P_POS_PRINT_PAY = new P_POS_PRINT_PAY();
                        if (P_POS_PRINT_PAY.ShowDialog() == DialogResult.OK)
                        {
                            result = P_POS_PRINT_PAY.ResultPrint;
        ...
        private void BtnContents_Click(object sender, EventArgs e)
        {
            ...
            if (ContentsType == ContentsMode.Customer)
            {
                ...
                if (dr.Length > 0)
                {
                    ...
                    string LastDt = A.GetString(dr[0]["DT_LAST_PO"]) == string.Empty ? string.Empty : A.GetString(dr[0]["DT_LAST_PO"]);
                    string VisitQt = A.GetString(dr[0]["QT_VISIT_PO"]) + " 회";
        ...
        private void TempSlipSave()
        {
            ...
            if (_dtTempH.Rows.Count == 0)
            {
                ...
                drNew["NO_PO"] = string.Empty;
                drNew["DT_PO"] = dtpSale.Text;
                drNew["CD_CUST"] = CustomerCode;
                drNew["NM_CUST"] = CustomerName;
                drNew["YN_RETURN"] = "N";
                drNew["FG_PO"] = SlipFlag;
                drNew["AM_DISCOUNT"] = 0;
            ...
            if (_dtTempPay.Rows.Count == 0)
            {
                ...
                //결제테이블 데이터 업데이트
                drNew["NO_BILL"] = string.Empty;
                drNew["DT_BILL"] = dtpSale.Text;
                drNew["CD_CUST"] = CustomerCode;
                drNew["YN_RETURN"] = "N";
        ...
        private void TempSlipView()
        {
            ...
            if (_dtTempH.Rows.Count == 1)
            {
                ...
                dtpSale.DateTimeChanged -= DtpSale_DateTimeChanged;
                dtpSale.Text = A.GetString(_dtTempH.Rows[0]["DT_PO"]);
                dtpSale.DateTimeChanged += DtpSale_DateTimeChanged;
                ...
                if (_dtTempPay.Rows.Count == 1)
                {
                    ...
                    SlipNoPay = _dtTempPay.Rows[0]["NO_BILL"].ToString();
                }
                else
                {
                    txtClsPayAmt.EditValue = 0;
            ...
            //외상잔액
            txtPreNonPaidAmt.EditValue = GetNonPaidAmt(new object[] { POSGlobal.StoreCode, CustomerCode, SlipNo, dtpSale.Text, "P" });
        ...
        private void InitForm()
        {
            ...
            _dtCust = SearchCust(new object[] { POSGlobal.StoreCode, string.Empty, "Y", dtpSale.Text, CustomerType });
            _dtItem = _dtItemType = SearchItem(new object[] { POSGlobal.StoreCode, string.Empty, string.Empty, string.Empty, UseItem });

            _dtItemAll = SearchItem(new object[] { POSGlobal.StoreCode, string.Empty, "ALL", string.Empty, UseItem });
        ...
        string SlipNoPay { get; set; } = string.Empty;
        public override void OnSave()
        {
            try
            {
                ...
                if (SlipNoPay == string.Empty)
                    SlipNoPay = A.GetPOSSlipNo(POSGlobal.StoreCode, SaleDt, "PAY", 4);
                #endregion 전표번호 채번

                //미수금 입금시 FG_PO = "P"  A:일반  R:반품  P:판매없이 수금
                if (gridViewItem.RowCount == 0)
                {
                    SlipFlag = "P";
                }
                ...
                if (_dtPay.Rows.Count == 0)
                {
                    ...
                    //결제테이블 데이터 업데이트
                    drNew["NO_BILL"] = SlipNoPay;
                    drNew["DT_BILL"] = SaleDt;
                    drNew["CD_CUST"] = CustomerCode;
                    drNew["YN_RETURN"] = "N";
                    drNew["NO_EMP"] = POSGlobal.EmpCode;
                    drNew["NO_PO"] = SlipNo;
                ...
                if (Save(dtHChange, dtLChange, dtPayChange, listParam))
                {
                    ...
                    if (SlipNoTemp!= null && SlipNoTemp.Count > 0)
                    {
                        for (int i = 0; i < SlipNoTemp.Count; i++)
                        {
                            UpdateTemp(new object[] { POSGlobal.StoreCode, SlipNoTemp[i], "P" });
                        }
                        SlipNoTemp.Clear();
                    }
                    //저장후 재계산 보이기
        ...
        private void Search(string pSlipNo)
        {
            ...
            if (_dtH.Rows.Count == 1)
            {
                ...
                if (_dtPay.Rows.Count == 1)
                {
                    ...
                    SlipNoPay = _dtPay.Rows[0]["NO_BILL"].ToString();
                }
                else
                {
                    txtClsPayAmt.EditValue = 0;
            ...
            if (pSlipNo != A.GetDummyString)
            {
                txtPreNonPaidAmt.EditValue = GetNonPaidAmt(new object[] { POSGlobal.StoreCode, CustomerCode, pSlipNo, dtpSale.Text, "P" });
                //선택한 거래처의 앞 뒤 전표 번호 가져오기
        ...
        {
            //선택한 거래처의 앞 뒤 전표 번호 가져오기
            DataTable dsSalesNo = SearchPreNextSlipNo(new object[] { POSGlobal.StoreCode, CustomerCode, pSlipNo, POSGlobal.SaleDt });

            if (dsSalesNo != null && dsSalesNo.Rows.Count > 0)
            {
                _salesNoPre = A.GetString(dsSalesNo.Rows[0]["NO_PO_PRE"]);
                _salesNoNext = A.GetString(dsSalesNo.Rows[0]["NO_PO_NEXT"]);
