...
namespace POS
{
    public partial class M_POS_OLD54 : POSFormBase
    {
        ...
        private void BtnCust_Click(object sender, EventArgs e)
        {
            ...
            P_POS_CONTENTS_SINGLE.StoredProcedure = "USP_OLD_SEARCH54_CUST";
        ...
        {
            POSPrintHelper.POSReportPrintOld("R_POS_OLD_SEARCH54_DAY", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSort.EditValue) });

        }

        private void PrintNormalDayItem()
        {
            POSPrintHelper.POSReportPrintOld("R_POS_OLD_SEARCH54_DAYITEM", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "YN_SUM", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSumYN.EditValue), A.GetString(aRadioButtonSort.EditValue) });

        }

        private void PrintNormalItem()
        {
            POSPrintHelper.POSReportPrintOld("R_POS_OLD_SEARCH54_ITEM", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "YN_SUM", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSumYN.EditValue), A.GetString(aRadioButtonSort.EditValue) });

        }

        private void PrintNormalMonth()
        {
            POSPrintHelper.POSReportPrintOld("R_POS_OLD_SEARCH54_MONTH", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "YN_SUM", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSumYN.EditValue), A.GetString(aRadioButtonSort.EditValue) });
