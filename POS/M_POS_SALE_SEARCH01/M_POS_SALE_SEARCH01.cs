...
namespace POS
{
    public partial class M_POS_SALE_SEARCH01 : POSFormBase
    {
        ...
        private void InitEvent()
        {
            ...
            gridView1.CustomSummaryCalculate += GridView_CustomSummaryCalculate;
        ...
        private void InitializeControl()
        {
            ...
            gridView1.Columns["AM_SALE"].SummaryItem.DisplayFormat = "{0:##,##0.####}";
        ...
        private void BtnCust_Click(object sender, EventArgs e)
        {
            ...
            P_POS_CONTENTS_SINGLE.CustomerType = "2";
        ...
        {
            POSPrintHelper.POSReportPrint("R_POS_SALE_SEARCH01", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSort.EditValue) });

        }

        private void PrintNormalDayItem()
        {
            POSPrintHelper.POSReportPrint("R_POS_SALE_SEARCH02", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "YN_SUM", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSumYN.EditValue), A.GetString(aRadioButtonSort.EditValue) });

        }

        private void PrintNormalItem()
        {
            POSPrintHelper.POSReportPrint("R_POS_SALE_SEARCH03", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "YN_SUM", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSumYN.EditValue), A.GetString(aRadioButtonSort.EditValue) });

        }

        private void PrintNormalMonth()
        {
            POSPrintHelper.POSReportPrint("R_POS_SALE_SEARCH04", new string[] { "CD_STORE", "DT_FROM", "DT_TO", "CD_CUST", "YN_SUM", "FG_SORT" }, new string[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), A.GetString(aRadioButtonSumYN.EditValue), A.GetString(aRadioButtonSort.EditValue) });
        ...
        public override void OnView()
        {
            ...
            if (TabControlMain.SelectedTabPageIndex == 0)
            {
                ...
                DataTable dt = SearchDay(new object[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), aRadioButtonSumYN.EditValue, aRadioButtonSort.EditValue });
            ...
            else if (TabControlMain.SelectedTabPageIndex == 1)
            {
                ...
                DataTable dt = SearchDayItem(new object[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), aRadioButtonSumYN.EditValue, aRadioButtonSort.EditValue });
            ...
            else if (TabControlMain.SelectedTabPageIndex == 2)
            {
                ...
                DataTable dt = SearchItem(new object[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), aRadioButtonSumYN.EditValue, aRadioButtonSort.EditValue });
            ...
            else if (TabControlMain.SelectedTabPageIndex == 3)
            {
                ...
                DataTable dt = SearchMonth(new object[] { POSGlobal.StoreCode, dtpFrom.Text, dtpTo.Text, A.GetDatatableToString(aLookUpEditCust.Properties.DataSource), aRadioButtonSumYN.EditValue, aRadioButtonSort.EditValue });
