...
namespace MAS
{
    public partial class M_MAS_CODE : BifrostFormBase
    {
        public M_MAS_CODE()
        {
            InitializeComponent();
        ...
        private void InitializeEvent()
        {
            ...
            btnAddMain.Click += BtnAddMain_Click;
            btnDeleteMain.Click += BtnDeleteMain_Click;
        ...
        {
            if(gridView2.GetFocusedDataRow().RowState == DataRowState.Added)
        ...
        {
            if (gridView1.GetFocusedDataRow().RowState == DataRowState.Added)
        ...
        {
            GridView view = sender as GridView;
            view.SetRowCellValue(e.RowHandle, view.Columns["CD_CLAS"], gridView1.GetFocusedRowCellValue("CD_CLAS"));
            view.SetRowCellValue(e.RowHandle, view.Columns["YN_SYSTEM"], "Y");
            view.SetRowCellValue(e.RowHandle, view.Columns["YN_USE"], "Y");
        }
        ...
        private void GridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                string ModuleCode = gridView1.GetFocusedRowCellValue("CD_MODULE").ToString();
                string ClassCode = gridView1.GetFocusedRowCellValue("CD_CLAS").ToString();

                gridView2.ActiveFilterString = "CD_CLAS = '" + ClassCode + "'";
        ...
        public override void OnView()
        {
            try
            {
                object[] obj = new object[] { Global.FirmCode, txtSearch.Text, aLookUpEditModule.EditValue };
