...
{
    public partial class POPUP_APNTCODE : PopupBase
    {
        ...
        public POPUP_APNTCODE(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_APNT", "발령코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_APNT", "발령명", aGridColumnStyle.Text, 150, false, true);
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_HRS_APNTCODE_S", new object[] { Global.FirmCode, txtSearch.Text });
                aGridM.Binding(dt);
