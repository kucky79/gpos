...
{
    public partial class POPUP_DGCODE : PopupBase
    {
        ...
        public POPUP_DGCODE(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_DGCODE", "근태코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_DG", "근태명", aGridColumnStyle.Text, 150, false, true);
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_HRS_DGCODE_S", new object[] { Global.FirmCode, txtSearch.Text });
                aGridM.Binding(dt);
