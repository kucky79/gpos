...
{
    public partial class POPUP_HRSLCTR : PopupBase
    {
        ...
        public POPUP_HRSLCTR(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_LCTR", "강사코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_LCTR", "강사명", aGridColumnStyle.Text, 150, false, true);
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_HRS_LCTRCODE_S", new object[] { Global.FirmCode, txtSearch.Text });
                aGridM.Binding(dt);
