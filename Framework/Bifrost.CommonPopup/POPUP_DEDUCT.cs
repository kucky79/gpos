...
{
    public partial class POPUP_DEDUCT : PopupBase
    {
        ...
        public string TpCondition
        {
            get { return _tpdeduct; }
            set { _tpdeduct = value; }
        }

        public POPUP_DEDUCT(string tpdeduct)
        {
            InitializeComponent();
            InitForm();
            InitEvent();

            TpCondition = tpdeduct;
        }

        public POPUP_DEDUCT(string SearchCode, string tpdeduct)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_DEDUCT", "소득자코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_DEDUCT", "소득자명", aGridColumnStyle.Text, 150, false, true);
                SetColumn AM = new SetColumn(gridView1, "AM_DEDUCT", "", aGridColumnStyle.Text, 150, false, false);
                SetColumn RT = new SetColumn(gridView1, "RT_DEDUCT", "", aGridColumnStyle.Text, 150, false, false);
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_HRS_DEDUCT_S", new object[] { Global.FirmCode, TpCondition, txtSearch.Text });
                aGridM.Binding(dt);
