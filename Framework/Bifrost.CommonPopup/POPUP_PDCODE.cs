...
{
    public partial class POPUP_PDCODE : PopupBase
    {
        ...
        public POPUP_PDCODE(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        public POPUP_PDCODE(string Tppopup, string Popupst)
        {
            Popupstyle = Popupst;
            Tppd = Tppopup;
        ...
        public POPUP_PDCODE(string Tppopup, string Popupst, string fgrpay)
        {
            Popupstyle = Popupst;
            Tppd = Tppopup;
            Fgrpay = fgrpay;
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_"+ Fgrpay+"PAY", Strnmcol+"코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_" + Fgrpay + "PAY", Strnmcol + "명", aGridColumnStyle.Text, 150, false, true);
                if (Popupstyle == "2")
                {
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_HRS_" + Fgrpay + "PDCODE_S", new object[] { Global.FirmCode, StrTppd, txtSearch.Text });
                aGridM.Binding(dt);
