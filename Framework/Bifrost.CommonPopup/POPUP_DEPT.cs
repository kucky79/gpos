...
{
    public partial class POPUP_DEPT : PopupBase
    {
        ...
        public POPUP_DEPT(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_DEPT", "부서코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_DEPT", "부서명", aGridColumnStyle.Text, 150, false, true);
                SetGridStyle(aGridM, false, true, false);
                gridView1.IndicatorWidth = 29;

                #endregion Grid Initialize
                aDateEdit_Rfdate.Text = A.GetToday;
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_MAS_DEPT_S", new object[] { Global.FirmCode, txtSearch.Text, aDateEdit_Rfdate.Text });
                aGridM.Binding(dt);
