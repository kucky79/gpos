...
{
    public partial class POPUP_BIZ : PopupBase
    {
        ...
        public POPUP_BIZ(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                PopupTitle = "Office PopUp";

                #region Grid Initialize

                SetColumn CODE = new SetColumn(gridView1, "CD_BIZ", "Office Code", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_BIZ", "Office Name", aGridColumnStyle.Text, 150, false, true);
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_MAS_BIZ_S", new object[] { Global.FirmCode, txtSearch.Text });
                aGridM.Binding(dt);
