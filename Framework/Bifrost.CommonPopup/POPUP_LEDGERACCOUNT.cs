...
{
    public partial class POPUP_LEDGERACCOUNT : PopupBase
    {
        ...
        //public POPUP_LEDGERACCOUNT(string SearchCode)
        //{
        //    InitializeComponent();
        //    InitForm();
        //    InitEvent();
        ...
        public POPUP_LEDGERACCOUNT(string Popupst)
        {
            Popupstyle = Popupst;
        ...
        private void InitForm()
        {
            try
            {
                PopupTitle = "계정과목 정보조회";
                #region Grid Initialize

                SetColumn CODE = new SetColumn(gridView1, "LEDGERACCOUNT", "계정과목코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "LEDGERACCOUNTNAME", "계정과목명", aGridColumnStyle.Text, 150, false, true);
                if (Popupstyle == "2")
                {
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_GW_LEDGERACCOUNT_S", new object[] {Global.FirmCode,  txtSearch.Text });
                aGridM.Binding(dt);
