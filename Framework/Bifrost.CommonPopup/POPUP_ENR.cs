...
{
    public partial class POPUP_ENR : PopupBase
    {
        DataTable dt = new DataTable();
        private string _Code = "";
        private string _tpENR = "";
        public string Code
        {
            get { return _Code; }
            set { _Code = value; }
        ...
        public POPUP_ENR(string SearchCode, string tpENR)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        private void InitForm()
        {
            try
            {
                ...
                SetColumn CODE = new SetColumn(gridView1, "CD_ENR", "소득자코드", aGridColumnStyle.Text, 100, false, true);
                SetColumn NAME = new SetColumn(gridView1, "NM_ENR", "소득자명", aGridColumnStyle.Text, 150, false, true);
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_HRS_ENR_S", new object[] { Global.FirmCode, TpCondition, txtSearch.Text });
                aGridM.Binding(dt);
