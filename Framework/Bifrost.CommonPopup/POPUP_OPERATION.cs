...
{
    public partial class POPUP_OPERATION : PopupBase
    {
        ...
        public POPUP_OPERATION(string SearchCode)
        {
            InitializeComponent();
            InitForm();
            InitEvent();
        ...
        protected override void OnSearch()
        {
            try
            {
                ...
                dt = DBHelper.GetDataTable("AP_H_PRD_OPERATION_S", new object[] { Global.FirmCode, txtSearch.Text, "P"  });
