...
{
    public partial class BifrostFormBase : FormBase
    {
        ...
        private void Default_StyleChanged(object sender, EventArgs e)
        {
            ...
            //commonSkin.SvgPalettes[Skin.DefaultSkinPaletteName].GetSvgColor(;
            if(svgPalette != null)
                panelNavigation.Appearance.BackColor = svgPalette.GetColor("Accent Paint");
        }
        ...
        private void FormInitialize()
        {
            ...
            //Color backColor = DXSkinColors.FillColors.Primary;
            //panelTop.Appearance.BackColor = backColor;
