...
{
    public delegate void BeforeOnViewEventHandler();
    public delegate void AfterOnViewEventHandler();
    public partial class MDIBase : FormBase
    {
        /// <summary>
        ...
        private FormBase _ActiveMdiForm;

        /// <summary>
        /// Current Active Form
        /// </summary>
        public FormBase ActiveMdiForm
        {
        ...
        public POSGlobalData POSGlobal;
        ...
        public virtual void SetSystemDate(string saleDate)
        {
        }
    ...
    /// <summary>
    /// Common Code Helper Base Class
    /// </summary>
    public class CommonCodeHelperBase
    {
        public CommonCodeHelperBase(string strCompanyCode, string strLangusge, bool loadOnDemand)
        {
        }
        ...
        public virtual DataTable GetSubCodes(string MajorCode, bool blnIncludeEmpty, string IncludeAllString, object includeAllValue)
        {
            return null;
        }

        public virtual DataTable GetSubCodes(string MajorCode)
        {
            return GetSubCodes(MajorCode, false, "", null);
        }

        public virtual DataTable GetSubCodes(string MajorCode, bool blnIncludeEmpty)
        {
            return GetSubCodes(MajorCode, blnIncludeEmpty, "", null);
        }

        public virtual DataTable GetSubCodes(string MajorCode, string IncludeAllString, object includeAllValue)
        {
            return GetSubCodes(MajorCode, false, IncludeAllString, includeAllValue);
        }

        public virtual DataTable GetSubCodes(string strMajorCode, bool bIncludeEmpty, string IncludeAllString, object includeAllValue, string filterExpression, string DisplayMember, string ValueMember)
        {
            return null;
        }
