...
{
    public partial class aPeriodEdit : Control
    {
        ...
        private void InitEvent()
        {
            ...
            btnMonth1.Click += BtnMonth_Click;
            btnMonth3.Click += BtnMonth_Click;
            btnMonth6.Click += BtnMonth_Click;
            btnYear.Click += BtnMonth_Click;
            btnMonthThis.Click += BtnMonth_Click;
            btnMonthLast.Click += BtnMonth_Click;
        }
        ...
        [Browsable(true), Description("시작일을 입력합니다. 형식은 yyyyMMdd 입니다.")]
        ...
        [Browsable(true), Description("종료일을 입력합니다. 형식은 yyyyMMdd 입니다.")]
        public string DtEnd
        {
            get
            {
