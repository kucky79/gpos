...
namespace Bifrost.Win.Controls
{
    ...
    public class RepositoryItemaDateMonth : RepositoryItemDateEdit
    {
        ...
        static RepositoryItemaDateMonth()
        {
            RegisteraDateEdit();
        }

        public RepositoryItemaDateMonth() : base()
        {
        }
        ...
        {
            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(aDateEditName, typeof(aDateMonth),typeof(RepositoryItemaDateMonth), typeof(DateEditViewInfo), new ButtonEditPainter(), true, picBack));
        }
        ...
        public override void Assign(RepositoryItem item)
        {
            ...
            {
                base.Assign(item);
                RepositoryItemaDateMonth source = item as RepositoryItemaDateMonth;
