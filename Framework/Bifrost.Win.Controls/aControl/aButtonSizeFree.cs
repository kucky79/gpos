...
namespace Bifrost.Win.Controls
{
    ...
    [ToolboxItem(true)]
    public class aButtonSizeFree : UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            // aButton
            // 
            //this.BackColor = System.Drawing.ColorTranslator.FromHtml("#2B3849");
            //BorderColor = _BorderColorDefalut;
            //ForeColor = _FontColorDefault;
			...
			if(iHeight != 0)
			{
				...
				switch (ImageAlign)
				{
					case ContentAlignment.BottomCenter:
						ptImage = new Point(Convert.ToInt32((this.Width / 2) - (iWidth / 2)), (this.Height - iHeight) );
						break;
					case ContentAlignment.BottomLeft:
						ptImage = new Point(0, (this.Height - iHeight) );
						break;
					case ContentAlignment.BottomRight:
						ptImage = new Point((this.Width - iWidth) , (this.Height - iHeight));
						break;
					case ContentAlignment.MiddleCenter:
						ptImage = new Point(Convert.ToInt32((this.Width / 2) - (iWidth / 2)), Convert.ToInt32((this.Height / 2) - (iHeight / 2)));
						break;
					case ContentAlignment.MiddleLeft:
						ptImage = new Point(0, Convert.ToInt32((this.Height / 2) - (iHeight / 2)));
						break;
					case ContentAlignment.MiddleRight:
						ptImage = new Point((this.Width - iWidth) , Convert.ToInt32((this.Height / 2) - (iHeight / 2)));
						break;
					case ContentAlignment.TopCenter:
						ptImage = new Point(Convert.ToInt32((this.Width / 2) - (iWidth / 2)), 0);
						break;
					case ContentAlignment.TopLeft:
						ptImage = new Point(0, 0);
						break;
					default:
						ptImage = new Point((this.Width - iWidth) , 0);
						break;
				}
		...
		[Browsable(true), DefaultValue(typeof(String), "")]
        ...
        private Color _BackColor = Color.White;// Settings.ButtonBackColor;
        ...
        private Color _ForeColor = Color.Black;// Settings.ButtonBackColor;
			...
			foreach (Control itm in this.Parent.Controls)
			{
				...
				if (this.GetType().Name == itmTypeName)
				{
					if (itm.Name != this.Name)
					{
						...
						{
							if (((aButtonSizeFree)itm).GroupKey == this.GroupKey)
							{
								((aButtonSizeFree)itm).Selected = true;
							}
						}
						else
						{
							if (((aButtonSizeFree)itm).GroupKey == null)
							{
								((aButtonSizeFree)itm).Selected = false;
							}
						}
					}
				}
        ...
        {
            private aButtonSizeFree _Button;

            public aButtonSizeFree Button
            {
                get { return _Button; }
                set { _Button = value; }
            }

            public SelectedChangedEventArgs(aButtonSizeFree theButton)
            {
