...
namespace NF.Framework.Win.Validation
{
	...
	/// </summary>
	public class ValidationSummaryForm : BaseValidationSummaryForm
	{
    ...
    private System.Windows.Forms.Label label1;
		...
		private void InitializeComponent()
		{
			...
			this.closeButton.Location = new System.Drawing.Point(259, 220);
			...
			this.validationErrorsList.FormattingEnabled = true;
			this.validationErrorsList.IntegralHeight = false;
			this.validationErrorsList.ItemHeight = 12;
			this.validationErrorsList.Location = new System.Drawing.Point(10, 25);
			this.validationErrorsList.Name = "validationErrorsList";
			this.validationErrorsList.Size = new System.Drawing.Size(338, 167);
			...
			this.lblErrorMessage.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.lblErrorMessage.Location = new System.Drawing.Point(10, 9);
			this.lblErrorMessage.Name = "lblErrorMessage";
			this.lblErrorMessage.Size = new System.Drawing.Size(338, 17);
			...
			this.MinimumSize = new System.Drawing.Size(365, 284);
    ...
    private void ValidationSummaryForm_Load(object sender, System.EventArgs e) {
      ...
      if( this.Owner != null ) {
		...
		#region BaseValidationSummaryForm Members

		public override void SetError(string errorCaption, string errorMessage)
		{
			ErrorCaption = errorCaption;
			ErrorMessage = errorMessage;
		}

		public override void LoadValidators(ValidatorCollection validators)
		{
