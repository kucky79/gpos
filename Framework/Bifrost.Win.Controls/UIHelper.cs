...
namespace Bifrost.Win.Controls
{
    ...
    public class UIHelper
	{
        ...
        //                ((TextBox)pTarget).ResetText();
        //                break;
        //            case "System.Windows.Forms.CheckBox" :
        //                ((CheckBox)pTarget).Checked = false;
        //                break;
        //            case "System.Windows.Forms.ComboBox":
        //                if (((System.Windows.Forms.ComboBox)pTarget).SelectedIndex != -1)
        //                {
        //                    ((ComboBox)pTarget).SelectedIndex = 0;
        //                }
        //                break;
        ...
        ///// <summary>
        ///// Format UltraNumericEditor control following NF StyleGuide
        ///// and 
        ///// </summary>
        ///// <param name="numericEditor"></param>
        ///// <param name="decimalCount"></param>
        ///// <param name="allowNegative"></param>
        //public static void ApplyDefaultStyle(UltraNumericEditor numericEditor,
        //    int length, int decimalCount, bool allowNegative)
        //{
        //    numericEditor.MaskClipMode = Infragistics.Win.UltraWinMaskedEdit.MaskMode.Raw;
        //    numericEditor.MaskDisplayMode = Infragistics.Win.UltraWinMaskedEdit.MaskMode.IncludeLiterals;
        //    numericEditor.TabNavigation = Infragistics.Win.UltraWinMaskedEdit.MaskedEditTabNavigation.NextControl;
        //    numericEditor.NumericType = NumericType.Double;
        //    numericEditor.MaxValue = 10000000000000;
        //    numericEditor.MinValue = -10000000000000;

        //    ///
        //    /// Get GlobalSettings
        //    /// 
        //    //GlobalSettings gs = UIHelper.GetGlobalSettings(numericEditor);
        ...
        //    //{double:-9.4:c}
        //    numericEditor.MaskInput = string.Concat("{LOC}", string.Format("{0}{1}", (allowNegative ? "-" : ""), formatString));
        //}

        /// <summary>
        /// Apply default format to DatePicker control
        /// </summary>
        /// <param name="datetimeEditor"></param>
        //public static void ApplyDefaultStyle(UltraDateTimeEditor datetimeEditor)
        //{
        //    ///
        //    /// Get GlobalSettings
        //    /// 

        //    datetimeEditor.DropDownButtonDisplayStyle = Infragistics.Win.ButtonDisplayStyle.Always;
        //    datetimeEditor.MaskClipMode = Infragistics.Win.UltraWinMaskedEdit.MaskMode.Raw;
        //    datetimeEditor.MaskDisplayMode = Infragistics.Win.UltraWinMaskedEdit.MaskMode.IncludeLiterals;
        //    datetimeEditor.UseFlatMode = DefaultableBoolean.True;
        //    datetimeEditor.MaskInput = "{LOC}" + "yyyy-mm-dd";
        //    datetimeEditor.AlwaysInEditMode = true;
        //}
        ...
        public static object GetControlPropertyValue(Control control, string propertyName)
		{
			try
			{
		...
		public static object GetControlPropertyValue(Control control, Type controlType, string propertyName)
		{
			try
			{
				object controlValue = null;
        ...
        public static string GetCurrentSubSystemType(Control control)
		{
        ...
        public static FormSettings GetFormSettings(Control control)
		{
			Form f = control.FindForm();
