...
namespace Bifrost.Helper
{
    public class ExcelHelper
    {
        ...
        /// <param name="UseFirstLineHeader"></param>
        /// <returns></returns>
        public static DataSet OpenExcelDB(string ExcelFile, bool UseFirstLineHeader)
        {
            return OpenExcel(ExcelFile, UseFirstLineHeader);
        }
