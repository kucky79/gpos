...
{
    public partial class aCodeTextNonPopup : ControlBase
    {
        ...
        private void _CodeBox_LostFocus(object sender, EventArgs e)
        {
            ...
            {
                _isResultChk = false;
                Debug.WriteLine(_isResultChk.ToString());
            }
            //if(!_isPopUpOpen)
            SetEvent();
        ...
        private void SetData()
        {
            ...
            _OldCodeValue = CodeValue;
            _OldCodeName = CodeName;
        ...
        private void CallNullValue()
        {
            ...
            switch (this.PopUpID)
            {
                ...
                //    dt = DBHelper.GetDataTable("AP_H_INT_PICKUP_S", new object[] { Global.FirmCode, Global.BizCode, _CodeBox.Text, "", "", "", "", "", "", "", CondTP });
